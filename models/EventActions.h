...
namespace drogon_model
{
    namespace sqlite3
    {
        ...
        public:
             ...
             */
            explicit EventActions(const Row &r, const ssize_t indexOffset = 0) noexcept;

            /**
             * @brief constructor
             * @param pJson The json object to construct a new instance.
             */
            explicit EventActions(const Json::Value &pJson) noexcept(false);
             ...
             */
            EventActions(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
            ...
            const uint64_t &getValueOfAction() const noexcept;
            ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
            const std::shared_ptr<uint64_t> &getAction() const noexcept;

            ///Set the value of the column action
            void setAction(const uint64_t &pAction) noexcept;
        ...
        private:
            ...
            std::shared_ptr<uint64_t>          action_;
