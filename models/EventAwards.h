    ...
    namespace sqlite3
    {
        ...
        public:
            struct Cols
            {
                ...
                static const std::string _rep_issued;
            };
             ...
             */
            explicit EventAwards(const Row &r, const ssize_t indexOffset = 0) noexcept;

            /**
             * @brief constructor
             * @param pJson The json object to construct a new instance.
             */
            explicit EventAwards(const Json::Value &pJson) noexcept(false);
             ...
             */
            EventAwards(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
            ...
            /**  For column rep_issued  */
            ///Get the value of the column rep_issued, returns the default value if the column is null
            const uint64_t &getValueOfRepIssued() const noexcept;
            ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
            const std::shared_ptr<uint64_t> &getRepIssued() const noexcept;

            ///Set the value of the column rep_issued
            void setRepIssued(const uint64_t &pRepIssued) noexcept;
        ...
        private:
            ...
            std::shared_ptr<uint64_t>          repIssued_;
            struct MetaData
            {
